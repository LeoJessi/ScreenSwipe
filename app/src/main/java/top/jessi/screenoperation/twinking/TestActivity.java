...
import top.jessi.screenoperation.twinking.adapter.ScienceAdapter;
import top.jessi.screenoperation.twinking.utils.ToastUtil;
import top.jessi.twinking.Footer.LoadingView;
import top.jessi.twinking.RefreshListenerAdapter;
import top.jessi.twinking.TwinklingRefreshLayout;
import top.jessi.twinking.header.SinaRefreshView;
...
//        TextHeaderView headerView = (TextHeaderView) View.inflate(this,R.layout.header_tv,null);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ToastUtil.show(TestActivity.this,"item clicked!");
            }
        });
