package top.jessi.screenoperation.swipeback;
...
import top.jessi.swipeback.app.SwipeBackActivity;


/**
 * Created by Issac on 8/11/13.
 */
public class SwipebackActivity extends SwipeBackActivity implements View.OnClickListener {
    ...
    private void saveTrackingMode(int flag) {
        SharedPreferences preferences = getSharedPreferences("swipeback", MODE_PRIVATE);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putInt(mKeyTrackingMode, flag).apply();
    }

    private void restoreTrackingMode() {
        SharedPreferences preferences = getSharedPreferences("swipeback", MODE_PRIVATE);
        int flag = preferences.getInt(mKeyTrackingMode, SwipeBackLayout.EDGE_LEFT);
